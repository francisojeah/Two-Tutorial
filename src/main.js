...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, express, views, staticAssets;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    views = (0, path_1.join)(__dirname, '..', 'views');
                    /*Finally, configure nunjucks, setting views and express declared above*/
                    nunjucks.configure(views, { express: express });
                    staticAssets = (0, path_1.join)(__dirname, '..', 'static');
