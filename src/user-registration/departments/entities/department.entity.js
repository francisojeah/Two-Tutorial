...
var Department = /** @class */ (function (_super) {
    ...
    ], Department.prototype, "isActive");
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return user_entity_1.User; }, function (users) { return users.department; })
    ], Department.prototype, "users");
