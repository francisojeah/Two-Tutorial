...
var RolesService = /** @class */ (function () {
    ...
    RolesService.prototype.create = function (createRoleDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newRole = this.roleRepository.create(createRoleDto);
                        return [4 /*yield*/, this.roleRepository.save(newRole)];
    ...
    RolesService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleRepository.findOne({
                            where: {
                                id: id // same as id:id
                            }
                        })];
    ...
    RolesService.prototype.update = function (id, updateUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleRepository.update(id, updateUserDto)];
                    case 1: 
    ...
    RolesService.prototype.setRoleById = function (roleId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.roleRepository.createQueryBuilder()
                                .relation(role_entity_1.Role, "user")
                                .of(roleId)
                                .add(userId)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
    ...
    RolesService.prototype.unsetRoleById = function (roleId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RolesService.prototype.loadRoleRelation = function (roleId) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
